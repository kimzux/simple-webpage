        ...
        <div name="map" className='w-screen relative' >
            <div className='flex flex-col justify-center  my-5' >
                ...
                <div className='flex justify-center mx-10 mt-10'>
                    <img src={MapImage} alt="my profile" className="w-10/12 mt-4 ml-10 md:w-2/3 object-cover " />
                    <div>
            ...
            <img src={MapLeft} alt="my profile" className="w-1/2 md:w-11/12 mx-10 md:mx-20 " />
            </div>
